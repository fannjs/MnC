...
function getMachineList(currentPage, recordEachPage) {
    ...
    $.ajax({
        ...
        url: "/views/reports/fullKioskList/main.aspx/getMachineList",
        ...
        success: function (data) {
            ...
            if (totalRecord == 0) {
                ...
                for (var index = 1; index < data.d.length; index++) {
                    machines = machines + '<tr><td>' + data.d[index].MCount + '</td><td>' + data.d[index].MachID + '</td><td>' + data.d[index].MState + '</td><td>' + data.d[index].MCity + '</td>'
                                      + '<td>' + data.d[index].MAddress1 + '</td><td>' + data.d[index].MAddress2 + '</td><td>' + data.d[index].MBranch + '</td><td>' + data.d[index].MPIC + '</td></tr>';
                }
