<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="longestResponseMain.aspx.cs" Inherits="Maestro.views.reports.longestResponse.longestResponseMain" %>
...
<script type="text/javascript">
    function search() {
        ...
        window.open("reports/longestResponse/longestResponseOutput.aspx?startDate=" + sDate + "&endDate=" + eDate + "&machType=" + machType + "&machID=" + machID + "&chartType=" + chartType + "&userName=" + userName + "", "_blank", "height=600, width=900, left=50, top=50, " +
