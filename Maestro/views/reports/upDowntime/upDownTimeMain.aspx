<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="upDownTimeMain.aspx.cs" Inherits="Maestro.views.reports.upDowntime.upDownTimeMain" %>
...
<script type="text/javascript">
    function search() {
        ...
        window.open("reports/upDowntime/upDownTimeOutput.aspx?startDate=" + sDate + "&endDate=" + eDate + "&machType=" + machType + "&machID=" + machID + "&chartType=" + chartType + "&userName=" + userName + "", "_blank", "height=600, width=900, left=50, top=50, " +
