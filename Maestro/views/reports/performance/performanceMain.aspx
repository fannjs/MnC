<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="performanceMain.aspx.cs" Inherits="Maestro.views.reports.performance.performanceMain" %>
    ...
    <div id="selectionDiv" class="well-div">
        ...
        <div class="field-group">
            ...
            <asp:dropdownlist class="input-field width-lg" id="selectChartType" runat="server">
               <asp:ListItem value="LineChart" selected> Line Chart </asp:ListItem>
            </asp:dropdownlist>
        </div>
        <div class="block-xs"></div>
        <div class="field-group">
...
<script type="text/javascript">
    function search() {
        ...
        window.open("reports/performance/performanceOutput.aspx?startDate=" + sDate + "&endDate=" + eDate + "&machType=" + machType + "&machID=" + machID + "&chartType=" + chartType + "&userName=" + userName + "", "_blank", "height=600, width=900, left=50, top=50, " +
