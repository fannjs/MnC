...
namespace Maestro.views.reports.problemStatistics
{
    public partial class problemStatisticsOutput : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    crystalReport.Load(rptpath + "/mProblemSta_barChart.rpt");
                }
                else
                {
                    crystalReport.Load(rptpath + "/mProblemSta_pieChart.rpt");
                }
