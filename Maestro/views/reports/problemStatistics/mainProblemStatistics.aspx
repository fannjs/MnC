<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mainProblemStatistics.aspx.cs" Inherits="Maestro.views.reports.problemStatistics.mainProblemStatistics" %>
...
<script type="text/javascript">
    function search() {
        ...
        //window.open("reports/statusReport/statusReportOutput.aspx?startDate=2015-01-03&endDate=2015-01-23", "_blank", "height=500, width=575, left=150, top=150, " +
        window.open("reports/problemStatistics/problemStatisticsOutput.aspx?startDate=" + sDate + "&endDate=" + eDate + "&machType=" + machType + "&machID=" + machID + "&chartType=" + chartType + "&userName=" + userName + "", "_blank", "height=600, width=900, left=50, top=50, " +
