<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="longestDowntimeMain.aspx.cs" Inherits="Maestro.views.reports.longestDowntime.longestDowntimeMain" %>
...
<script type="text/javascript">
    function search() {
        ...
        window.open("reports/longestDowntime/longestDowntimeOutput.aspx?startDate=" + sDate + "&endDate=" + eDate + "&machType=" + machType + "&machID=" + machID + "&chartType="+chartType+"&userName=" + userName + "", "_blank", "height=600, width=900, left=50, top=50, " +
