<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="editEscalation.aspx.cs" Inherits="Maestro.views.administration.statusCodeEscalation.editEscalation" %>

<script src="administration/statusCodeEscalation/editEscalation.js" type="text/javascript"></script>
<div>
    <div id="editEscalationMainDiv" class="well-div">
        <legend>Edit Status Code Escalation</legend>
        <div class="field-group">
            <label class="form-label width-md">Kiosk Type</label>
            <span id="selectKioskType" runat="server"></span>
            <input type="hidden" id="groupIdHidden" runat="server" />
        </div>
        <div class="field-group">
        ...
        <div class="field-group">
            ...
            <button class="btn btn-primary editEscalationBtn" onclick="updateEscalation();">Update</button>
            <button class="btn btn-default editEscalationBtn" onclick="showMainPage();">Cancel</button>
        </div>
    </div>
