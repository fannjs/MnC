<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="advEdit.aspx.cs" Inherits="Maestro.views.kioskMaintenance.advMaintenance.advEdit" %>
...
<script type="text/javascript">
    ...
    */
                ...
                <legend>Edit Advertisement Assignment</legend>
...
<%--    <div id="specific-assigment-first-div">
    ...
    <div>
        <p><b>File Name: CSDAdv1001.zip</b></p>
        </div>
        ...
        <table class="table" id="tbDetails">
            ...
            <tbody>
<%--                <tr><td><input type="text" value="1" style="width: 50px"></td><td> ABC.jpg</td><td><input type="checkbox" name="vehicle"  checked="checked"></td> </tr>
                <tr><td><input type="text" value="2" style="width: 50px"></td><td>BCD.png</td><td><input type="checkbox" name="vehicle" checked="checked" ></td> </tr>
                <tr><td><input type="text" value="3" style="width: 50px"></td><td>CDE.avi</td><td><input type="checkbox" name="vehicle" checked="checked" ></td> </tr>
                <tr><td><input type="text" value="4" style="width: 50px"></td><td>DEF.mp4</td><td><input type="checkbox" name="vehicle" checked="checked" ></td> </tr>
                <tr><td><input type="text" value="5" style="width: 50px"></td><td>EFC.jpg</td><td><input type="checkbox" name="vehicle" checked="checked" ></td> </tr>
                <tr><td><input type="text" value="6" style="width: 50px"></td><td>MYA.png</td><td><input type="checkbox" name="vehicle" checked="checked" ></td> </tr>
                <tr><td><input type="text" value="7" style="width: 50px"></td><td>SDF.avi</td><td><input type="checkbox" name="vehicle" checked="checked" ></td> </tr>
                <tr><td><input type="text" value="8" style="width: 50px"></td><td>TTD.mp4</td><td><input type="checkbox" name="vehicle" checked="checked"  ></td> </tr>
                <tr><td><input type="text" value="9" style="width: 50px"></td><td>EFC.jpg</td><td><input type="checkbox" name="vehicle" checked="checked" ></td> </tr>
                <tr><td><input type="text" value="10" style="width: 50px"></td><td>MYA.png</td><td><input type="checkbox" name="vehicle" checked="checked" ></td> </tr>--%>

                <tr><td>01</td><td> ABC.jpg</td><td><input type="checkbox" name="vehicle"  checked="checked"></td> </tr>
                <tr><td>02</td><td>BCD.png</td><td><input type="checkbox" name="vehicle" checked="checked" ></td> </tr>
                <tr><td>03</td><td>CDE.avi</td><td><input type="checkbox" name="vehicle" checked="checked" ></td> </tr>
                <tr><td>04</td><td>DEF.mp4</td><td><input type="checkbox" name="vehicle" checked="checked" ></td> </tr>
                <tr><td>05</td><td>EFC.jpg</td><td><input type="checkbox" name="vehicle" checked="checked" ></td> </tr>
                <tr><td>06</td><td>MYA.png</td><td><input type="checkbox" name="vehicle" checked="checked" ></td> </tr>
                <tr><td>07</td><td>SDF.avi</td><td><input type="checkbox" name="vehicle" checked="checked" ></td> </tr>
                <tr><td>08</td><td>TTD.mp4</td><td><input type="checkbox" name="vehicle" checked="checked"  ></td> </tr>
                <tr><td>09</td><td>EFC.jpg</td><td><input type="checkbox" name="vehicle" checked="checked" ></td> </tr>
                <tr><td>10</td><td>MYA.png</td><td><input type="checkbox" name="vehicle" checked="checked" ></td> </tr>
                
                <tr><td><button type="submit" class="btn btn-primary" onclick="addNewUpload()">Add New</button></td><TD></TD> <TD></TD></tr>
            </tbody>
        </table>
                </div>
        </div>
