 ...
 public static   class SqlMapperUtil
    {
      ...
      {
        string connString = "";//roy modify to [1], come back and fix next time
        connString= name==null?connString = ConfigurationManager.ConnectionStrings[1].ConnectionString:  connString = ConfigurationManager.ConnectionStrings[name].ConnectionString;
